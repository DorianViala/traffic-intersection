...
# Read file and convert from string to int
fd = open('currentGreen', 'r')
line = fd.readline()
c = int(line)
currentGreen = c   # Indicates which signal is green currently
fd.close()
...
def repeat():
    ...
    # Write nextGreen to file
    nG = str(nextGreen)
    f = open('currentGreen', 'w')
    f.write(nG)
    f.close()
    ...
    try:
        ...
        currentGreen = -1
        print(Fore.RED + "[ERROR] Can't read currentGreen")
